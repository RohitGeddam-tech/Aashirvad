    ...
    return(
        <div className='mainmobsheet'>
            <div className='imgmobsheet'>
                ...
                <img className='sheetmobimg' src={location} style={{marginBottom:'50px'}}/>
            </div>
            <div className='contentmobsheet'>
                ...
                <p class="themobheader" style={{marginBottom:'35px'}}>Bldg No 108, Ground Floor, Heera Nav Jeevan Society, Pant Nagar, Ghatkopar (E), Mumbai, Maharashtra - 75</p>
            </div>
        </div>
    )
}
